...
- **2026-04-14** 🤖 **Z.ai Coding Platform Support**: Added native support for the **Z.ai** (formerly Zhipu AI) coding platform. Optimized for the `glm-5.1` model via the dedicated coding endpoint. `vibe-trading init` now includes Z.ai in the interactive setup.
