...
2. Use the [GitHub Security Advisory](https://github.com/cosmic-hydra/Vibe-Trading/security/advisories/new) to report privately.
...
This policy applies to the [cosmic-hydra/Vibe-Trading](https://github.com/cosmic-hydra/Vibe-Trading) repository.
...
- Our only official Discord is **https://discord.gg/6TdQnT5xcF** (the cosmic-hydra community server,
...
See the pinned security announcement in [Discussions](https://github.com/cosmic-hydra/Vibe-Trading/discussions)
