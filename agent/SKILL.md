...
- **Strategy registry** — unified discovery layer with scenario-aware routing (15 built-in strategies from QuantsPlaybook)
...
| `get_strategy` | Get full strategy details from registry | None |
| `list_strategies` | List all strategies in the registry | None |
| `query_strategies` | Query strategies by scenario/market/sharpe | None |
