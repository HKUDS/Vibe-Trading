        ...
        "properties": {
            ...
            "source": {
                ...
                "description": (
                    ...
                    "package, else Korea falls back to yahoo/yfinance), nse_ke "
                    "(Kenya NSE daily bars for <CODE>.NR, e.g. SCOM.NR, from the "
                    "exchange's daily price list; close is the session VWAP; "
                    "needs the optional nse-ke extra). Key-gated "
