...
| tickerall | Forex & metals (your broker's MT5 feed, hosted) | Yes (`TICKERALL_API_KEY` + `TICKERALL_ACCOUNT_ID`) | Hosted API (any OS, no terminal) | data-routing (runner-internal) |
...
- **Forex / metals**: mt5 (local MetaTrader 5 terminal, Windows) > tickerall (hosted MT5 API, any OS) > akshare.
