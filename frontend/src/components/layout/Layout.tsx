...
import { Activity, BarChart3, Bot, CalendarClock, CandlestickChart, Check, ChevronDown, FileText, Languages, Moon, Sun, Plus, Trash2, Pencil, MessageSquare, ChevronsLeft, ChevronsRight, Settings, Landmark, Layers, Loader2, WalletCards } from "lucide-react";
...
export function Layout() {
  ...
  const NAV = [
    ...
    { to: "/markets/kenya", icon: Landmark, label: t('layout.kenyaBoard') },
