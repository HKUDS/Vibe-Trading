...
function useCategories(t: ReturnType<typeof useI18n>["t"]): Category[] {
  return [
    {
      label: t.multiMarketBacktest,
      icon: <TrendingUp className="h-4 w-4" />,
      color: "text-red-400 border-red-500/30 hover:border-red-500/60 hover:bg-red-500/5",
      examples: [
        {
          title: t.crossMarketPortfolio,
          desc: t.crossMarketPortfolioDesc,
    ...
    },
    {
      ...
      examples: [
        ...
        {
          title: t.optionsGreeks,
          desc: t.optionsGreeksDesc,
    ...
    },
    {
      ...
      examples: [
        {
          title: t.investmentCommittee,
          desc: t.investmentCommitteeDesc,
        ...
        {
          title: t.quantStrategyDesk,
          desc: t.quantStrategyDeskDesc,
    ...
    },
    {
      ...
      examples: [
        ...
        {
          title: t.diagnoseBehaviorBiases,
          desc: t.diagnoseBehaviorBiasesDesc,
    ...
    },
    {
      ...
      examples: [
        ...
        {
          title: t.howMuchLeaving,
          desc: t.howMuchLeavingDesc,
        ...
        {
          title: t.generateShadowReport,
          desc: t.generateShadowReportDesc,
...
function useCapabilityChips(t: ReturnType<typeof useI18n>["t"]): string[] {
  return [
    t.chipFinanceSkills,
    t.chipSwarmPresets,
    t.chipAgentTools,
    t.chipMarkets,
    t.chipTimeframes,
    t.chipPortfolioOptimizers,
    t.chipRiskMetrics,
    t.chipOptionsDerivatives,
    t.chipPdfWebResearch,
    t.chipFactorAnalysis,
    t.chipTradeJournal,
    t.chipShadowAccount,
    t.chipPersistentMemory,
    t.chipSessionSearch,
  ];
}
...
export function WelcomeScreen({ onExample }: Props) {
  ...
  const capabilityChips = useCapabilityChips(t);
