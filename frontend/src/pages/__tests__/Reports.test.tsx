...
describe("Reports page", () => {
  ...
  it("lists backtest reports newest first and filters out non-report runs", async () => {
    ...
    expect(reportLinks[0]).toHaveAttribute("href", "/runs/new-report");
    expect(reportLinks[1]).toHaveAttribute("href", "/runs/old-report");
  });
